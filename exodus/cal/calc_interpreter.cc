...
namespace exodus::cal {
    ...
    using operators_map_type = std::map<std::string, std::function<double(double first_argument,
    ...
    nl::json interpreter::kernel_info_request_impl() {
        ...
        std::string banner = ""
                             ...
                             "//     // ////////  ///////  ////////          //////  //      // ////////   ////// \n"
                             "\n"
                             " Implementation of a calculator based on RPN through dwarf";
